...
# Rutas de las escenas de enemigos
var enemy_scenes: Array = [
	preload("res://enemy/enemy.tscn"),
	preload("res://enemy_prueba/enemy1.tscn")
]
...
func spawn_enemy() -> void:
	# Seleccionar aleatoriamente una de las escenas de enemigo
	...
	# Configurar capas para que los enemigos no se detecten entre sí
	enemy_instance.collision_layer = 1
	enemy_instance.collision_mask = 2  # Solo detectan al jugador
